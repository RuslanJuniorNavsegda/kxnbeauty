...
function contactUs(productName) {
  alert(
    `Для заказа "${productName}" свяжитесь с нами по телефону +7 (495) 123-45-67 или напишите на info@kxnbeauty.ru`
  );
}
...
const faqItems = [
  {
    ...
    a: "Мы доставляем по всей России курьерскими службами и почтой. Сроки 2-7 дней в зависимости от региона.",
  },
  {
